...
3. Implement your changes, ensuring adherence to coding conventions and proper documentation.
4. Test your changes thoroughly.
5. Commit your changes: ``git commit -m 'Add: Description of changes'`
6. Push to your branch: `git push origin feature/new-feature`
7. Open a pull request in the original repository, detailing the changes made and any additional information related to the pull request.
## License
